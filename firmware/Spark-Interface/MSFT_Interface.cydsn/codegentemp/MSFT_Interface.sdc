...
# Date: Wed, 12 Aug 2015 22:22:35 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_3} -source [get_pins {ClockBlock/clk_sync}] -edges {1 67 133} -nominal_period 1000 [list [get_pins {ClockBlock/dclk_glb_2}]]
create_generated_clock -name {U_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 73 145} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clock_2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 661 1321} -nominal_period 10000 [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\Owner\Documents\GitHub\Spark_Firmware\firmware\Spark-Interface\MSFT_Interface.cydsn\MSFT_Interface.cyprj
# Date: Wed, 12 Aug 2015 22:22:19 GMT
