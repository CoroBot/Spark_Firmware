...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=10105264, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=ADC_SAR, )
...
// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1422208, Adjust=0, ClockSource=0, InputRange=1, NumChannels=1, Reference=0, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=88888, SampleRate_def=631579, VrefValue=2.5, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=ADC, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=101, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=65535, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=PWM_2, )
module PWM_v3_30_5 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=101, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=65535, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_3, CY_INSTANCE_SHORT_NAME=PWM_3, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=PWM_3, )
module PWM_v3_30_6 (
    pwm2,
    tc,
    clock,
...
module top ;
	...
	wire [0:0] tmpOE__nRE_net;
	wire [0:0] tmpFB_0__nRE_net;
	wire [0:0] tmpIO_0__nRE_net;
	wire [0:0] tmpINTERRUPT_0__nRE_net;
	electrical [0:0] tmpSIOVREF__nRE_net;

	cy_psoc3_pins_v1_10
		#(.id("dcba4eb5-c0b9-4b3b-9e2b-387464653171"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		nRE
		 (.oe(tmpOE__nRE_net),
		  .y({Net_318}),
		  .fb({tmpFB_0__nRE_net[0:0]}),
		  .io({tmpIO_0__nRE_net[0:0]}),
		  .siovref(tmpSIOVREF__nRE_net),
		  .interrupt({tmpINTERRUPT_0__nRE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__nRE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_1 U (
        ...
        .reset(1'b0),
        .rx(Net_223),
        .tx_interrupt(Net_288),
        .rx_interrupt(Net_289),
        .tx_data(Net_290),
        .tx_clk(Net_291),
        .rx_data(Net_292),
        .rx_clk(Net_293));
    defparam U.Address1 = 0;
    defparam U.Address2 = 0;
    defparam U.EnIntRXInterrupt = 1;
    defparam U.EnIntTXInterrupt = 1;
    defparam U.FlowControl = 0;
    defparam U.HalfDuplexEn = 0;
    defparam U.HwTXEnSignal = 1;
    defparam U.NumDataBits = 8;
    defparam U.NumStopBits = 1;
    defparam U.ParityType = 0;
    defparam U.RXEnable = 1;
    defparam U.TXEnable = 1;

    CyControlReg_v1_80 RS485CTL (
        .control_1(Net_305),
        .control_2(Net_306),
        .control_3(Net_307),
        .control_0(Net_315),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam RS485CTL.Bit0Mode = 0;
    defparam RS485CTL.Bit1Mode = 0;
    defparam RS485CTL.Bit2Mode = 0;
    defparam RS485CTL.Bit3Mode = 0;
    defparam RS485CTL.Bit4Mode = 0;
    defparam RS485CTL.Bit5Mode = 0;
    defparam RS485CTL.Bit6Mode = 0;
    defparam RS485CTL.Bit7Mode = 0;
    defparam RS485CTL.BitValue = 0;
    defparam RS485CTL.BusDisplay = 0;
    defparam RS485CTL.ExtrReset = 0;
    defparam RS485CTL.NumOutputs = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("6f5f227b-d574-4d16-b74d-153bdb3c254f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Vpot_net;
	wire [0:0] tmpFB_0__Vpot_net;
	wire [0:0] tmpIO_0__Vpot_net;
	wire [0:0] tmpINTERRUPT_0__Vpot_net;
	electrical [0:0] tmpSIOVREF__Vpot_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vpot
		 (.oe(tmpOE__Vpot_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vpot_net[0:0]}),
		  .analog({Net_743}),
		  .io({tmpIO_0__Vpot_net[0:0]}),
		  .siovref(tmpSIOVREF__Vpot_net),
		  .interrupt({tmpINTERRUPT_0__Vpot_net[0:0]}),
		  .annotation({Net_1581}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Vpot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a88b7a39-2e17-432e-9156-2d31dd77004b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d5d21e2-0236-4608-999d-5075a5ddc2aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("76ce17a0-01dc-49d5-bb98-f1724440bd2f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SRVO1_net;
	wire [0:0] tmpFB_0__SRVO1_net;
	wire [0:0] tmpIO_0__SRVO1_net;
	wire [0:0] tmpINTERRUPT_0__SRVO1_net;
	electrical [0:0] tmpSIOVREF__SRVO1_net;

	cy_psoc3_pins_v1_10
		#(.id("a2f3f844-f170-4855-85b8-9ecff1eb59d4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SRVO1
		 (.oe(tmpOE__SRVO1_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__SRVO1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SRVO1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TrigSignal_net;
	wire [0:0] tmpFB_0__TrigSignal_net;
	wire [0:0] tmpIO_0__TrigSignal_net;
	wire [0:0] tmpINTERRUPT_0__TrigSignal_net;
	electrical [0:0] tmpSIOVREF__TrigSignal_net;

	cy_psoc3_pins_v1_10
		#(.id("7880308e-cfba-4474-b6b3-50486e4d7b54"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TrigSignal
		 (.oe(tmpOE__TrigSignal_net),
		  .y({Net_4279}),
		  .fb({tmpFB_0__TrigSignal_net[0:0]}),
		  .io({tmpIO_0__TrigSignal_net[0:0]}),
		  .siovref(tmpSIOVREF__TrigSignal_net),
		  .interrupt({tmpINTERRUPT_0__TrigSignal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TrigSignal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_3881));

    Timer_v2_70_9 Timer_1 (
        .reset(Net_4187),
        .interrupt(Net_4277),
        .enable(1'b1),
        .trigger(Net_4279),
        .capture(Net_3779),
        .capture_out(Net_4280),
        .tc(Net_4281),
        .clock(Net_4162));
	...
	wire [0:0] tmpOE__EchoSignal_net;
	wire [0:0] tmpIO_0__EchoSignal_net;
	wire [0:0] tmpINTERRUPT_0__EchoSignal_net;
	electrical [0:0] tmpSIOVREF__EchoSignal_net;

	cy_psoc3_pins_v1_10
		#(.id("39ce85a7-4eab-470c-9019-b4f4dfeb855f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EchoSignal
		 (.oe(tmpOE__EchoSignal_net),
		  .y({1'b0}),
		  .fb({Net_3779}),
		  .io({tmpIO_0__EchoSignal_net[0:0]}),
		  .siovref(tmpSIOVREF__EchoSignal_net),
		  .interrupt({tmpINTERRUPT_0__EchoSignal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EchoSignal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
