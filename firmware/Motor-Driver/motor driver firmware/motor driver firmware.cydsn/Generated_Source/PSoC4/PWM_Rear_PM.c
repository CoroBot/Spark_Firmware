...
static PWM_Rear_BACKUP_STRUCT PWM_Rear_backup;
...
{
    if(0u != (PWM_Rear_BLOCK_CONTROL_REG & PWM_Rear_MASK))
    {
        PWM_Rear_backup.enableState = 1u;
    }
    else
    {
        PWM_Rear_backup.enableState = 0u;
    }
...
void PWM_Rear_Wakeup(void)
{
    ...
    if(0u != PWM_Rear_backup.enableState)
    {
        PWM_Rear_Enable();
    }
}
