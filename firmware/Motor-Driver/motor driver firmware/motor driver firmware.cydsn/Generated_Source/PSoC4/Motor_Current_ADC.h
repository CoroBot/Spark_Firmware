...
#define Motor_Current_ADC_TOTAL_CHANNELS_NUM             (1u)
#define Motor_Current_ADC_SEQUENCED_CHANNELS_NUM         (1u)
#define Motor_Current_ADC_DEFAULT_EN_CHANNELS            (1u)
#define Motor_Current_ADC_NOMINAL_CLOCK_FREQ             (3000000)
