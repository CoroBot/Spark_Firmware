...
# Project: I:\Dropbox (Personal)\coroware\github\Spark_Firmware\firmware\Motor-Driver\motor driver firmware\motor driver firmware.cydsn\motor driver firmware.cyprj
# Date: Mon, 18 Apr 2016 21:41:26 GMT
#set_units -time ns
...
create_clock -name {Motor_Current_ADC_intClock(FFB)} -period 333.33333333333331 -waveform {0 166.666666666667} [list [get_pins {ClockBlock/ff_div_7}]]
...
create_generated_clock -name {Motor_Current_ADC_intClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 9 17} [list]
create_generated_clock -name {UART_SCBCLK} -source [get_pins {ClockBlock/hfclk}] -edges {1 33 65} [list]

set_false_path -from [get_pins {__ONE__/q}]

# Component constraints for I:\Dropbox (Personal)\coroware\github\Spark_Firmware\firmware\Motor-Driver\motor driver firmware\motor driver firmware.cydsn\TopDesign\TopDesign.cysch
# Project: I:\Dropbox (Personal)\coroware\github\Spark_Firmware\firmware\Motor-Driver\motor driver firmware\motor driver firmware.cydsn\motor driver firmware.cyprj
# Date: Mon, 18 Apr 2016 21:41:23 GMT
